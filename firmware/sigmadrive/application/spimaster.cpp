...
void SPIMaster::chip_select(GPIO_TypeDef* NSS_GPIOx, uint16_t NSS_GPIO_Pin, bool select)
{
...
bool SPIMaster::transmit_receive(uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
