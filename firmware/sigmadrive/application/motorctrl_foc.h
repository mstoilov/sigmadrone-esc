...
public:
    struct Config {
        ...
        float pid_current_ki_ = 500;            /**< Current PID regulator integral gain */
        float pid_current_decay_ = 0.01;        /**< Current PID regulator decay rate */
        float pid_current_maxout_ = 45;         /**< Current PID regulator integral output limit */

        float pid_w_kp_ = 0.0075;               /**< Velocity PID regulator proportional gain */
        float pid_w_ki_ = 3;                    /**< Velocity PID regulator integral gain */
        float pid_w_decay_ = 0.01;              /**< Velocity PID regulator decay rate */
        float pid_w_maxout_ = 3.0;              /**< Velocity PID regulator integral output limit */

        float pid_p_kp_ = 2;                    /**< Position PID regulator proportional gain */
        float pid_p_ki_ = 0.0;                  /**< Position PID regulator integral gain */
        float pid_p_decay_ = 0.01;              /**< Position PID regulator decay rate */
...
protected:
    ...
    float q_current_ = 0.055;               /**< Q-current used for torque loop mode */
