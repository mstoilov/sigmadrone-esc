...
PWMDecoder::PWMDecoder(TIM_TypeDef *TIMx, const TimeSpan& pwm_period, const Frequency& system_clock, const std::vector<GPIOPin>& pins)
	: Timer(TIMx, pwm_period, system_clock, pins)
	, pwm_pulse_(0)
	, pwm_period_(0)
{
	DisableChannel(CH1);
