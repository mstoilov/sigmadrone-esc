...
void DigitalIn::vector_handler(size_t line)
{
	/* Manage Flags */
...
void DigitalIn::vector_handlers(size_t begin, size_t size)
{
...
void DigitalIn::extiline_enable(uint32_t portnum, uint32_t linenum, uint32_t irq_priority)
{
	__SYSCFG_CLK_ENABLE();
